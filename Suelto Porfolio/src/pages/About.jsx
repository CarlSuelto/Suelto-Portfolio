...
const About = () => {
  const socialLinks = [
    { 
      ...
      handle: '@CarlSuelto',
      brandColor: 'var(--brand-emerald)', // Keeps the requested default system hover theme style
      icon: (
        <svg 
          role="img" 
          viewBox="0 0 24 24" 
          width="24" 
          height="24"
          style={{ fill: 'var(--text-primary)', color: 'var(--text-primary)', display: 'block' }}
        >
    ...
    { 
      ...
      brandColor: '#E1306C', // Exact Instagram Magenta/Pink
      icon: (
        <svg 
          role="img" 
          viewBox="0 0 24 24" 
    ...
    { 
      ...
      brandColor: '#1877F2', // Exact Facebook Blue
      icon: (
        <svg 
          role="img" 
          viewBox="0 0 24 24" 
    ...
    { 
      ...
      isOutline: true,
      brandColor: '#EA4335', // Exact Gmail Red
      icon: (
        <svg 
          ...
          width="24" 
          height="24"
          style={{ stroke: 'var(--text-primary)', display: 'block' }}
        >
    ...
    { 
      ...
      brandColor: '#00F2EA', // Exact TikTok Teal/Cyan
      icon: (
        <svg 
          role="img" 
          viewBox="0 0 24 24" 
  ...
  return (
    <section id="about" className="about-section" style={{ backgroundColor: 'var(--bg-main)', color: 'var(--text-primary)', padding: '40px 20px', display: 'flex', flexDirection: 'column', gap: '24px', transition: 'background-color 0.3s ease, color 0.3s ease' }}>
      ...
      <style>{`
        ...
        /* Standard Resting Base Layout - Perfect readability in image_0d972d.png and image_0d9709.png */
        ...
        /* Dynamic Custom Variable Mapping On Hover */
        .social-item-box:hover {
          transform: translateY(-4px);
          border-color: var(--brand-color) !important;
        }
        .social-item-box:hover .social-icon-wrapper h4 {
          ...
          {socialLinks.map((social, index) => (
            <a 
              ...
              style={{ 
                ...
                gap: '8px', 
                textDecoration: 'none',
                '--brand-color': social.brandColor // Dynamically configures layout theme parameters 
              }}
            >
